...
Click "Add Object"![](assets_win/addObj.png) button to start the element spying, click the control you want to add, if the control is spied successfully, it shows the controls you want to add and its properties. Then you click "Add to Model"![image.png](assets_win/add.png) button to add it to the object model.
