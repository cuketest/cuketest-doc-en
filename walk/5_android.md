...
测试客户端:[https://github.com/appium/sample-code/tree/master/sample-code/apps/ApiDemos/bin](https://github.com/appium/sample-code/tree/master/sample-code/apps/ApiDemos/bin) 下载并安装到自己的手机。
...
2. 获取应用pacakage和启动的activity 命令行输入 `adb logcat | findstr START` 手动打开 **Demo API** 应用，从日志中获取。
...
4. 自动化测试代码 打开`step_definations\definitions1.js`文件，点击 step 后面的灰色按钮，生成自动化脚本样例。

   ![](../.gitbook/assets/script.png)

   使用uiautomatorviewer 工具定位到客户端元素

   ![](../.gitbook/assets/uiautomatorviewer.png)
